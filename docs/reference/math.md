...
You can get the smaller or the bigger of two numbers with the [min](/makecode-blockeditor/reference/math/min) and [max](/makecode-blockeditor/reference/math/max) functions.
...
[abs](/makecode-blockeditor/reference/math/abs), [min](/makecode-blockeditor/reference/math/min), [max](/makecode-blockeditor/reference/math/max),
[randomRange](/makecode-blockeditor/reference/math/random-range)